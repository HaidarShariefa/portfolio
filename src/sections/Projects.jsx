  ...
  const projects = [
    {
      ...
      description: 'A full-featured SaaS restaurants management system with WhatsApp integration from admin management panel to a stylish modern menu for users.',
    ...
    {
      title: 'Task Manager',
      description: 'A robust full-stack web application designed to streamline task management, user administration, and reporting.',
    ...
    },
    {
      ...
      description: 'Entire management system for demining companies, with multiple responsibility levels (searcher, supervisor, manager). Helped companies IRL increase safety.',
